                ...
                <table class="table caption-top">
                    ...
                    <tbody>
                        ...
                        <?php
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['id_inventario']?></th>
                                                <th><?php  echo $row['codigo']?></th>
                                                <th><?php  echo $row['id_proveedor']?></th>
                                                <th><?php  echo $row['Cantidad']?></th>
                                                <th><?php  echo $row['FechaEntrada']?></th>
                                                <th><?php  echo $row['FechaSalida']?></th>   
                                               <th><a href="actualizar.php?id=<?php echo $row['id_inventario'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="deleteinv.php?id=<?php echo $row['id_inventario'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
